...
(cl:defmethod cl:initialize-instance :after ((m <VelocityWorld>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityWorld)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name crazyflie_driver-msg:<VelocityWorld> is deprecated: use crazyflie_driver-msg:VelocityWorld instead.")))
...
(cl:defmethod vel-val ((m <VelocityWorld>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader crazyflie_driver-msg:vel-val is deprecated.  Use crazyflie_driver-msg:vel instead.")
  (vel m))
