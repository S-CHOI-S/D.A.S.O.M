...
class DasomDynamixel {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type DasomDynamixel
    // Serialize message field [header]
    bufferOffset = std_msgs.msg.Header.serialize(obj.header, buffer, bufferOffset);
    // Serialize message field [name]
    bufferOffset = _arraySerializer.string(obj.name, buffer, bufferOffset, null);
    // Serialize message field [flag]
    bufferOffset = _arraySerializer.uint8(obj.flag, buffer, bufferOffset, null);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type DasomDynamixel
    let len;
    let data = new DasomDynamixel(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [name]
    data.name = _arrayDeserializer.string(buffer, bufferOffset, null)
    // Deserialize message field [flag]
    data.flag = _arrayDeserializer.uint8(buffer, bufferOffset, null)
  ...
  static datatype() {
    ...
    return 'two_link/DasomDynamixel';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new DasomDynamixel(null);
