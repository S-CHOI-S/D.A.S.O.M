...
if("TRUE" STREQUAL "TRUE")
  set(unibas_face_detector_SOURCE_PREFIX /home/choisol/catkin_ws/src/aruco_detector)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'unibas_face_detector' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/choisol/catkin_ws/src/aruco_detector/${idir}'.  ${_report}")
    endif()
