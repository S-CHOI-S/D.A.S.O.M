...
"""autogenerated by genpy from rqt_mypkg/DasomDynamixel.msg. Do not edit."""
import codecs
import sys
...
class DasomDynamixel(genpy.Message):
  _md5sum = "5418eb35a4761ad0d066083a60dcf0ff"
  _type = "rqt_mypkg/DasomDynamixel"
...
string frame_id
"""
  __slots__ = ['header','name','flag','position','velocity','effort']
  _slot_types = ['std_msgs/Header','string[]','uint8[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,flag,position,velocity,effort
