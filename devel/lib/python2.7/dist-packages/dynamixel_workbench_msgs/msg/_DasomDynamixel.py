...
"""autogenerated by genpy from dynamixel_workbench_msgs/DasomDynamixel.msg. Do not edit."""
import codecs
import sys
...
class DasomDynamixel(genpy.Message):
  _md5sum = "653686a0fff23bcd522d582d3d8ae941"
  _type = "dynamixel_workbench_msgs/DasomDynamixel"
...
float64 w
"""
  __slots__ = ['header','name','flag','pose','position','velocity','effort']
  _slot_types = ['std_msgs/Header','string[]','uint8[]','geometry_msgs/Pose','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,flag,pose,position,velocity,effort
    ...
    """
    if args or kwds:
      super(DasomDynamixel, self).__init__(*args, **kwds)
