...
void publisherSet()
{
	...
	// dasom
	// data_log.data[96] = dasom_EE_command.linear.x;
	// data_log.data[97] = dasom_EE_command.linear.y;
	// data_log.data[98] = dasom_EE_command.linear.z;
	// data_log.data[99] = dasom_EE_command.angular.x;
	// data_log.data[100] = dasom_EE_command.angular.y;
	// data_log.data[101] = dasom_EE_command.angular.z;
	// data_log.data[102] = dasom_EE_measured.linear.x;
	// data_log.data[103] = dasom_EE_measured.linear.y;
	// data_log.data[104] = dasom_EE_measured.linear.z;
	// data_log.data[105] = dasom_EE_measured.angular.x;
	// data_log.data[106] = dasom_EE_measured.angular.y;
	// data_log.data[107] = dasom_EE_measured.angular.z;

	// data_log.data[108] = dasom_global_fixed_gimbal_EE_pose.pose.position.x;
	// data_log.data[109] = dasom_global_fixed_gimbal_EE_pose.pose.position.y;
	// data_log.data[110] = dasom_global_fixed_gimbal_EE_pose.pose.position.z;
	// data_log.data[111] = dasom_global_fixed_gimbal_EE_pose.pose.orientation.x;
	// data_log.data[112] = dasom_global_fixed_gimbal_EE_pose.pose.orientation.y;
	// data_log.data[113] = dasom_global_fixed_gimbal_EE_pose.pose.orientation.z;
	// data_log.data[113] = dasom_global_fixed_gimbal_EE_pose.pose.orientation.w;

	// data_log.data[114] = dasom_global_meas_gimbal_EE_pose.linear.x;
	// data_log.data[115] = dasom_global_meas_gimbal_EE_pose.linear.y;
	// data_log.data[116] = dasom_global_meas_gimbal_EE_pose.linear.z;
	// data_log.data[117] = dasom_global_meas_gimbal_EE_pose.angular.x;
	// data_log.data[118] = dasom_global_meas_gimbal_EE_pose.angular.y;

	// data_log.data[119] = dasom_meas_effort.effort[0];
	// data_log.data[120] = dasom_meas_effort.effort[1];
	// data_log.data[121] = dasom_meas_effort.effort[2];
	// data_log.data[122] = dasom_meas_effort.effort[3];
	// data_log.data[123] = dasom_meas_effort.effort[4];
	// data_log.data[124] = dasom_meas_effort.effort[5];
