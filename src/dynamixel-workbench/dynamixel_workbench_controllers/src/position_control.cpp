...
void PositionControl::initPublisher()
{
  ...
  dasom_joint_states_pub_ = node_handle_.advertise<dynamixel_workbench_msgs::DasomDynamixel>(robot_name_ + "/joint_states", 10);
...
void PositionControl::goalJointPositionCallback(const dynamixel_workbench_msgs::DasomDynamixel::ConstPtr &msg)
{
